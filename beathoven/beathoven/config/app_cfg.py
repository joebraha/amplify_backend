# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in beathoven.
...
import beathoven
from beathoven import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': beathoven.model,
    'DBSession': beathoven.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "31c78ae9-0d32-4a7b-8479-aa017ed8b82a",
